# -*- coding: utf-8 -*-
"""
Created on Fri Aug 17 19:39:19 2018
...
#gru = tf.contrib.rnn.GRUCell(n_hidden)
###单层静态rnn
#outputs = tf.contrib.rnn.static_rnn(gru, x1, dtype=tf.float32) #静态rnn中的inputs需是一个list

##单层动态rnn

#outputs,_ = tf.nn.dynamic_rnn(gru, X, dtype=tf.float32)  #动态rnn中的inputs需是一个三维张量
